using Loofshoot.Multiplayer.Runtime.Utils;
using System;
using System.Reflection;

namespace Loofshoot.Multiplayer.Runtime
{
    ...
    public class InvalidHandlerSignatureException : Exception
    {
        ...
        private static string GetErrorMessage(Type declaringType, string handlerMethodName)
        {
            return $"'{declaringType.Name}.{handlerMethodName}' doesn't match any acceptable message handler method signatures! Server message handler methods should have a 'ushort' and a '{nameof(Runtime.Message)}' parameter, while client message handler methods should only have a '{nameof(Runtime.Message)}' parameter.";
        }
    }
